...
exports.execute = async (client, message, args) => {
    ...
    if (!query) {
        return message.reply("Lütfen aramak istediğiniz ifadeyi belirtin. Örnek kullanım: `!webde ara [sorgu]`");
    }
    ...
    try {
        ...
        console.error(error);
        return message.reply("Arama sırasında bir hata oluştu. Lütfen tekrar deneyin.");
    }
};
